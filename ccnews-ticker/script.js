const news = {
	normal: [
		...
		"A local news station runs a 10-minute segment about your cookies. Success! (you win a cookie)",
		...
		"News : [2|1001] miners dead in chocolate mine catastrophe!",
		"News : [2|1001] miners trapped in collapsed chocolate mine!",
		...
		"News : explorers bring back ancient artifact from abandoned temple; archeologists marvel at the centuries-old [property] [object]!",
		"News : recently-discovered chocolate temples now sparking new cookie-related cult; thousands pray to Baker in the sky!",
		"News : just how extensive is the cookie pantheon? Theologians speculate about possible [god/goddess] of [stuff1].",
		...
		"News : all [stuff2] turned into [stuff2] in freak magic catastrophe!",
		"News : heavy dissent rages between the schools of [element] magic and [element] magic!",
		...
		"News : the person of the year is, this year again, [Bakeryname]! How unexpected!",
		"News : criminals caught sharing pirated copies of [Bakeryname]'s genome may be exposed to fines and up to 17 billion years prison, reminds constable.",
		"News : could local restaurants be serving you bootleg [Bakeryname] clone meat? Our delicious investigation follows after tonight's news.",
		"News : beloved cookie magnate [Bakeryname], erroneously reported as trampled to death by crazed fans, thankfully found to be escaped clone mistaken for original.",
		"News : \"Really, we're just looking for some basic societal acceptance and compassion\", mumbles incoherent genetic freak [Bakeryname]-Clone #59014.",
		"News : cookies found to [benefit] in [animal]!",
		"News : cookies found to make [animal] [modifier]!",
		...
		"News : \"[quote]\", reveals celebrity.",
		"News : doctors [publicServiceMessage]",
		"News : cookies go well with [preparation] [animal], says controversial chef.",
		...
		"News : cookies now more popular than [topic], says study.",
		"News : obesity epidemic strikes nation; experts blame [blame].",
		...
		"News : cookies could be the key to [ambition], says scientists.",
		"News : \"Ook\", says interviewed orangutan.",
		"News : flavor text [flavor], study finds.",
		...
		"News : [Bakeryname]-brand cookies \"[comparison] than competitors\", says consumer survey.",
		"News : \"[Bakeryname]\" set to be this year's most popular baby name.",
		"News : new popularity survey says [Bakeryname]'s the word when it comes to cookies.",
		"News : major city being renamed [Bakeryname]ville after world-famous cookie manufacturer.",
		"News : [discovery] to be named after [Bakeryname], the world-famous cookie manufacturer.",
		"News : don't miss tonight's biopic on [Bakeryname]'s irresistible rise to success!",
		"News : don't miss tonight's interview of [Bakeryname] by [celebrity]!",
		...
		"News : nation cheers as legislators finally outlaw [controversy]!",
		"News : \"average person bakes [Cookies Baked this Ascension/7.3 Billion] cookies a year\" factoid actually just statistical error; [Bakeryname], who has produced [Cookies Baked this Ascension] cookies in their lifetime, is an outlier and should not have been counted.",
		"News : overgrown cookies found in fishing nets, raise questions about hormone baking.",
		"News : [man/woman] wakes up from coma, [action].",
		...
		"News : person typing these wouldn't mind someone breaking the news to THEM, for a change",
...
const wordList = {
	animal: [
		"newts", "penguins", "scorpions", "axolotls", "puffins", "porpoises", "blowfish", "horses",
		"crayfish", "slugs", "humpback whales", "nurse sharks", "giant squids", "polar bears",
		"fruit bats", "frogs", "sea squirts", "velvet worms", "mole rats", "paramecia", "nematodes",
		"tardigrades", "giraffes", "monkfish", "wolfmen", "goblins", "hippies"
	],
	property: [
		"magic", "carved", "engraved", "sculpted", "royal", "imperial", "mummified", "ritual", "golden",
		"silver", "stone", "cursed", "plastic", "bone", "blood", "holy", "sacred", "sacrificial",
		"electronic", "singing", "tapdancing"
	],
	object: [
		"spoon", "fork", "pizza", "washing machine", "calculator", "hat", "piano", "napkin", "skeleton",
		"gown", "dagger", "sword", "shield", "skull", "emerald", "bathtub", "mask", "rollerskates",
		"litterbox", "bait box", "cube", "sphere", "fungus"
	],
	stuff1: [
		"kazoos", "web design", "web browsers", "kittens", "atheism", "handbrakes", "hats", "aglets",
		"elevator music", "idle games", "the letter \"P\"", "memes", "hamburgers", "bad puns", "kerning",
		"stand-up comedy", "failed burglary attempts", "clickbait", "one weird tricks"
	],
	stuff2: [
		"animal", "public restrooms", "clouds", "politicians", "moustaches", "hats", "shoes", "pants",
		"clowns", "encyclopedias", "websites", "potted plants", "lemons", "household items",
		"bodily fluids", "cutlery", "national landmarks", "yogurt", "rap music", "underwear"
	],
	element: [
		"water", "fire", "earth", "air", "lightning", "acid", "song", "battle", "peace", "pencil",
		"internet", "space", "time", "brain", "nature", "techno", "plant", "bug", "ice", "poison",
		"crab", "kitten", "dolphin", "bird", "punch", "fart"
	],
	benefit: [
		"increase lifespan", "sensibly increase intelligence", "reverse aging", "decrease hair loss",
		"prevent arthritis", "cure blindness"
	],
	modifier: [
		"more docile", "more handsome", "nicer", "less hungry", "more pragmatic", "tastier"
	],
	quote: [
		"I'm all about cookies", "I just can't stop eating cookies. I think I seriously need help",
	...
	publicServiceMessage: [
		"recommend twice-daily consumption of fresh cookies.",
		"warn against chocolate chip-snorting teen fad.",
		"advise against new cookie-free fad diet.",
		"warn mothers about the dangers of \"home-made cookies.\""
	],
	preparation: [
		"roasted", "toasted", "boiled", "sauteed", "minced", "sushi made of", "soup made of",
		"carpaccio made of", "steak made of", "nuggets made of"
	],
	topic: [
		"cough drops", "broccoli", "smoked herring", "cheese", "video games", "stable jobs",
		"relationships", "time travel", "cat videos", "tango", "fashion", "television",
		"nuclear warfare", "whatever it is we ate before", "politics", "oxygen", "lamps"
	],
	blame: [
		"twerking", "that darn rap music", "video-games", "lack of cookies",
		"mysterious ghostly entities", "aliens", "parents", "schools", "comic-books",
		"cookie-snorting fad"
	],
	headline: [
		"popcorn pretty *** popular; \"we kinda expected that\", say scientists.",
		"cereals break all known cereal-related records;",
		"popcorn sales exploded during screening of Grandmothers II : The Moistening."
	],
	ambition: [
		"eternal life", "infinite riches", "eternal youth", "eternal beauty", "curing baldness",
		"world peace", "solving world hunger", "ending all wars world-wide",
		"making contact with extraterrestrial life", "mind-reading", "better living", "better eating",
		"more interesting TV shows", "faster-than-light travel", "quantum baking",
		"chocolaty goodness", "gooder thoughtness"
	],
	flavor: [
		"not particularly flavorful", "kind of unsavory", "rather bland", "pretty spicy lately"
	],
	comparison: [
		"much less soggy", "much tastier", "relatively less crappy", "marginally less awful",
		"less toxic", "possibly more edible", "more fashionable", "slightly nicer", "trendier",
		"arguably healthier", "objectively better choice", "slightly less terrible",
		"decidedly cookier", "a tad cheaper"
	],
	discovery: [
		"street", "school", "nursing home", "stadium", "new fast food chain", "new planet",
		"new disease", "flesh-eating virus", "deadly bacteria", "new species of animal",
		"new law", "baby", "programming language"
	],
	celebrity: [
		"Bloprah", "Blavid Bletterman", "Blimmy Blimmel", "Blellen Blegeneres", "Blimmy Blallon",
		"Blonan Blo'Brien", "Blay Bleno", "Blon Blewart", "Bleven Blolbert",
		"Lord Toxikhron of dimension 7-B19", "[Bakeryname]'s own evil clone"
	],
	controversy: [
		"cookie criticism", "playing other games than Cookie Clicker", "pineapple on pizza",
		"lack of cheerfulness", "mosquitoes", "broccoli", "the human spleen", "bad weather",
		"clickbait", "dabbing", "the internet", "memes", "millenials"
	],
	action: [
		"asks for cookies, regrets it instantly", "wonders 'why everything is cookies now'",
		"babbles incoherently about some supposed non-cookie food we used to eat",
		"cites cookies as main motivator", "tries cookie for the first time, dies"
	]
};
...
function rand_int_string_input(string) {
	const match = string.match(/\[(\d+)\|(\d+)\]/);
	if (match) {
		const min = parseInt(match[1]);
		const max = parseInt(match[2]);
		return string.replace(match[0], random_int(min, max));
	}
	return string;
}

function random_string_input(string) {
	return string.replace(/\[([^\[\]]+\/[^\[\]]+)\]/g, (match, contents) => {
...
function generate_news() {
	...
	for (const word in wordList) {
		if (wordList.hasOwnProperty(word)) {
			...
			article = article.replace(regex, random(wordList[word]));
		}
	}
	return article;
}
...
function on_click() {
	document.getElementById("news").innerText = generate_news();
}

window.onload = function () { on_click(); }
